...
UTOSS_BOOT_ADDR ?= 32\'h0000_0000 # Currently only used in DV
...
RISCOF_VERILATOR_FLAGS := $(VERILATOR_FLAGS) $(UTOSS_RISCV_RISCOF_VERILATOR_DEFINES) -GBOOT_ADDR=$(UTOSS_BOOT_ADDR)
