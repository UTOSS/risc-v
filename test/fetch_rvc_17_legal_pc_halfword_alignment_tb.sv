...
module fetch_rvc_17_legal_pc_halfword_alignment_tb;
...
wait_fetch(32'h00000000, NOP,          "PC 0x00 aligned to halfword");
`assert_equal(if_to_id.pc_cur[0], 1'b0)

wait_fetch(32'h00000002, NOP,          "PC 0x02 aligned to halfword");
`assert_equal(if_to_id.pc_cur[0], 1'b0)

wait_fetch(32'h00000004, NOP,          "PC 0x04 aligned to halfword");
`assert_equal(if_to_id.pc_cur[0], 1'b0)

wait_fetch(32'h00000006, NOP,          "bubble at PC 0x06 still halfword aligned");
`assert_equal(if_to_id.pc_cur[0], 1'b0)

wait_fetch(32'h00000006, 32'h00A00093, "real split at PC 0x06 still halfword aligned");
`assert_equal(if_to_id.pc_cur[0], 1'b0)
...
`SETUP_VCD_DUMP(fetch_rvc_17_legal_pc_halfword_alignment_tb)
