...
module fetch_rvc_09_flush_while_buffer_valid_tb;
  ...
  initial begin
    ...
    wait_buffer_valid
      ( "same-word buffer becomes valid after lower compressed instruction"
      );
    ...
    wait_target_no_forbidden
      ( 32'h00000008
      , TARGET_INSTR
      , 32'h00000002
      , NOP
      , "flush while buffer valid must kill old buffered PC 0x02"
      );

    $finish;
  end

  `SETUP_VCD_DUMP(fetch_rvc_09_flush_while_buffer_valid_tb)
