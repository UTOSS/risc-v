...
module fetch_rvc_18_mixed_stream_stress_tb;
...
imem[1] = 32'h00A00093; // PC 0x04: aligned 32-bit
imem[2] = 32'h01130001; // PC 0x08: C.NOP, PC 0x0A: low half split
imem[3] = 32'h00010010; // PC 0x0C: high half split, PC 0x0E: C.NOP
imem[4] = 32'h00100113; // PC 0x10: aligned 32-bit

release_reset();

wait_fetch(32'h00000000, NOP,          "mixed: C at PC 0x00");
wait_fetch(32'h00000002, NOP,          "mixed: C at PC 0x02");
wait_fetch(32'h00000004, 32'h00A00093, "mixed: aligned 32 at PC 0x04");
wait_fetch(32'h00000008, NOP,          "mixed: C at PC 0x08");
wait_fetch(32'h0000000A, NOP,          "mixed: bubble for split at PC 0x0A");
wait_fetch(32'h0000000A, 32'h00100113, "mixed: real split at PC 0x0A");
wait_fetch(32'h0000000E, NOP,          "mixed: C at PC 0x0E");
wait_fetch(32'h00000010, 32'h00100113, "mixed: aligned 32 at PC 0x10");
...
`SETUP_VCD_DUMP(fetch_rvc_18_mixed_stream_stress_tb)
