...
module fetch_rvc_13_compressed_then_aligned_32_tb;
  ...
  initial begin
    ...
    imem[1] = 32'h00A00093; // PC 0x04: aligned ADDI

    release_reset();

    wait_fetch(32'h00000000, NOP,         "C.NOP at PC 0x00");
    wait_fetch(32'h00000002, NOP,         "C.NOP at PC 0x02");
    wait_fetch(32'h00000004, 32'h00A00093,"aligned 32-bit after compressed pair");

    $finish;
  end

  `SETUP_VCD_DUMP(fetch_rvc_13_compressed_then_aligned_32_tb)
