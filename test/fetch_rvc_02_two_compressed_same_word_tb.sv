...
module fetch_rvc_02_two_compressed_same_word_tb;
  ...
  initial begin
    ...
    imem[1] = NOP;         // PC 0x04: normal NOP

    release_reset();

    wait_fetch(32'h00000000, NOP, "lower C.NOP at PC 0x00");
    wait_fetch(32'h00000002, NOP, "upper C.NOP from same-word buffer at PC 0x02");
    wait_fetch(32'h00000004, NOP, "next aligned word at PC 0x04");

    $finish;
  end

  `SETUP_VCD_DUMP(fetch_rvc_02_two_compressed_same_word_tb)
