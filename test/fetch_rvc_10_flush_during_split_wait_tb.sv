...
module fetch_rvc_10_flush_during_split_wait_tb;
  ...
  localparam instr_t TARGET_INSTR = 32'h00100113;
  ...
  initial begin
    ...
    wait_target_no_forbidden
      ...
      , 32'h00000002
      , SPLIT_INSTR
      , "flush during split wait must kill old real split instruction"
      );

    $finish;
  end

  `SETUP_VCD_DUMP(fetch_rvc_10_flush_during_split_wait_tb)
