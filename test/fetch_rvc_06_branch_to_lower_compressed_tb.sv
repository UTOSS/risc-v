...
module fetch_rvc_06_branch_to_lower_compressed_tb;
  ...
  initial begin
    ...
    imem[0] = NOP;
    imem[1] = 32'h00010001; // PC 0x04: C.NOP, PC 0x06: C.NOP
    imem[2] = NOP;

    release_reset();

    redirect_to(32'h00000004);

    wait_fetch(32'h00000004, NOP, "branch target lower-half C.NOP at PC 0x04");
    wait_fetch(32'h00000006, NOP, "same-word buffered C.NOP at PC 0x06");

    $finish;
  end

  `SETUP_VCD_DUMP(fetch_rvc_06_branch_to_lower_compressed_tb)
