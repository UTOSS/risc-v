...
module fetch_rvc_07_branch_to_upper_compressed_tb;
  ...
  initial begin
    ...
    imem[0] = NOP;
    imem[1] = 32'h00010013; // PC 0x04: normal low half irrelevant-ish, PC 0x06: C.NOP
    imem[2] = NOP;

    release_reset();

    redirect_to(32'h00000006);

    wait_fetch(32'h00000006, NOP, "branch target upper-half C.NOP at PC 0x06");
    wait_fetch(32'h00000008, NOP, "fallthrough to next word after upper C.NOP");

    $finish;
  end

  `SETUP_VCD_DUMP(fetch_rvc_07_branch_to_upper_compressed_tb)
