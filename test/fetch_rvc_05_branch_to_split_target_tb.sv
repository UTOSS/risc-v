...
module fetch_rvc_05_branch_to_split_target_tb;
  ...
  initial begin
    ...
    imem[0] = 32'h00930001; // target PC 0x02 starts split ADDI
    imem[1] = 32'h000100A0; // completes split ADDI, then C.NOP at PC 0x06
    imem[2] = NOP;
  ...
  `SETUP_VCD_DUMP(fetch_rvc_05_branch_to_split_target_tb)
