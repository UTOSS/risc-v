...
class utoss_riscv(pluginTemplate):
    __model__ = "utoss_riscv"
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","utoss_riscv")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for utoss_riscv start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
